  ...
  return `<div class="co-shell">
    <aside class="co-side">
      ...
      <div class="co-user"><b>${admin.name}</b>${admin.role}<br>
        ${(typeof NET!=='undefined'&&NET)?'<button data-act="logout" style="background:none;border:0;color:#8b93a1;font-size:11px;padding:0;cursor:pointer">Sign out</button>':'<a href="#/console" style="color:#8b93a1;font-size:11px">Switch user</a>'}</div>
    </aside>

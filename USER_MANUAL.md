...
**1.2 Programme documents.** From the top navigation, open **For Mentees** (the mentee guide), **For Mentors** (the mentor brief), and **Reflection Sheet**. These pages hold the briefing content. *(Content shown is placeholder structure — final text comes from the programme team.)*

**1.3 Reflection Sheet page.** Note the badge at the top: **"This reflection is yours. The platform never stores what you write here — it records only your end-of-rotation close-off."** The page offers the three rotation templates (Know Yourself / Know Your World / Know Your Path) for participants to use privately.
...
**2.7 Builder Reflection (March).** After Rotation 3's close-off, your page asks for your closing **Builder Reflection** — a free-text reflection on how you'll contribute back. Submit → your journey shows Completed (pending certificate).

**2.8 Certificate.** When you qualify, your page shows your completion certificate and the demo displays the delivery email.
> **⚠ Inferred (R2-Q2):** certificate requires all three rotations closed off + Builder Reflection. Confirm rule and signatory.
...
**5.4 Certificates.** A closing view lists everyone with their qualification status against the certificate rule; qualified certificates generate and (in production) email automatically.
